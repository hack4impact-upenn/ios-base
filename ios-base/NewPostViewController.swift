...
class NewPostViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        postTitleField.frame = (frame: CGRect(x:0, y:0, width:240, height:30))
        ...
        postField.frame = (frame: CGRect(x:0, y:0, width:240, height:120))
        ...
        postButton.frame = (frame: CGRect(x: 0, y: 0, width: 120, height: 30))
